/*****************************************************************************
* Copyright (C) 2006 by Sam Siewerts
*
...
*****************************************************************************/
/*****************************************************************************
* Source code was provide by Dr. Siewerts for Course ECEN-5623 was slightly 
* modified to add five more scheduling scenarios to test as required in 
* exercise #2.
*****************************************************************************/
/**
* @file feasibility_tests.c
* @brief This source file contains a c program to perform a completion time
* and scheduling point feasibility test.
*
...
/************************************************************************
* Copied printf statement shown aboved and modified to satisfy  
* exercise 5 - 9 schedules. The code calculates the total CPU 
* utilization, then the number of services based on the period 
* array provided and the U32_T datatype prior to calling the 
...
/**********************************************
* End of Completion Test Feasibility Example. 
**********************************************/
...
/**************************************************** 
* This test ensures that the total cumulative demand (Ant)
* from the n task up to time t. Checking for "temp" being less
* than or equal to the deadline of service (n) confirms 
* whether this feasibility test passes or not and 
* as long as this is true for all services, this functions
* returns true. 
*****************************************************/
...
/*********************************************************
* This test implements the scheduling point test
* by following  the Lehoczky, Sha, Ding theorem, whichi
* states that if a set of services can be shown to meet
* all deadlines from the critical instant
* up to the longest deadline of all tasks in the set, 
* then the set is feasible. Per book Real-Time Embedded 
* Components and Systems Using Linux and RTOS, chapter 3.
************************************************************/
