...
// calls to syslog.
/*****************************************************************************
* Copyright (C) 2016 by Sam Siewerts
*
...
void main(void)
{
   ...
   printf("Using CPUS=%d from total available.\n", CPU_COUNT(&allcpuset));
	...
	/************************************************
	* Both fib threads get started and start running. 
	* After a determined amount of time, the sequencer 
	* thread is created, which has the highest priority
	* and will be incharge of coordinating the timing 
	* of execution and order of fib10 and fib 20.
	*************************************************/
